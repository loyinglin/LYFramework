...
- (instancetype)init {
    ...
    if (self) {
        ...
        mFrameInterval = 2;
        mWriterQueue = dispatch_queue_create("com.qianchuo.aulive.capture.writer", NULL);
...
- (void)startCapture {
    ...
    dispatch_async(mWriterQueue, ^{
        ...
        mAudioOutputQueue = dispatch_queue_create( "com.qianchuo.aulive.capture.audio", DISPATCH_QUEUE_SERIAL );
